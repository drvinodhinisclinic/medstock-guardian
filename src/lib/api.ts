import type { Product, Audit, StockInfo, DeliveryFormData, PhysicalAuditFormData, ApiResponse, MonthlySalesSummary, SupplierApiResponse, Supplier, NewProductFormData, CreateProductResponse } from '@/types/pharmacy';
